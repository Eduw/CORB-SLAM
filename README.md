...
The execution files for ROS and KITTI have been extended.
ROS: first camera input is [camera/image_raw], second camera input [camera/image_raw2].
Also do not use the cameraviewer. It is just a proof of concept and is not properly implemented.
